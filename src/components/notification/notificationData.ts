...
export type TripNotificationStatus = 'Pending Assignment' | 'Ready to Sent' | 'Resend Required' | 'Sent' | 'Not Required'
...
export const NOTIFICATIONS: CustomerNotification[] = [
  {
    ...
    phoneNumbers: ['(+65) 9123 4501'], emails: ['ops@sembawanglogistics.com.sg'], emailCc: ['admin@sembawanglogistics.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4502'], emails: ['logistics@glp.com.sg'], emailCc: ['admin@glp.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4567', '(+65) 9123 4568'],
    emails: ['daniel.tan@keppelinfra.com.sg', 'sales.tan@keppelinfra.com.sg', 'marco.antoni@keppelinfra.com.sg', 'romadio.tonio@keppelinfra.com.sg'],
    emailCc: ['sales.tan@keppelinfra.com.sg', 'marco.antoni@keppelinfra.com.sg', 'romadio.tonio@keppelinfra.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4504'], emails: ['events@mapletree.com.sg'], emailCc: ['admin@mapletree.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4505'], emails: ['ops@ych.com.sg'], emailCc: ['admin@ych.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4506'], emails: ['ops@sembawanglogistics.com.sg'], emailCc: ['admin@sembawanglogistics.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4507'], emails: ['transfer@psacorp.com.sg'], emailCc: ['admin@psacorp.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4508'], emails: ['delivery@dhl.com.sg'], emailCc: ['admin@dhl.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4509'], emails: ['moveins@capitaland.com.sg'], emailCc: ['admin@capitaland.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4510'], emails: ['equipment@stengg.com'], emailCc: ['admin@stengg.com'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4511'], emails: ['shuttle@jtc.gov.sg'], emailCc: ['admin@jtc.gov.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4512'], emails: ['transport@nus.edu.sg'], emailCc: ['admin@nus.edu.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4513'], emails: ['staff@rws.com.sg'], emailCc: ['admin@rws.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4514'], emails: ['transfer@cwt.com.sg'], emailCc: ['admin@cwt.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4515'], emails: ['crew@siaec.com.sg'], emailCc: ['admin@siaec.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4516'], emails: ['moveins@capitaland.com.sg'], emailCc: ['admin@capitaland.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4517'], emails: ['facilities@dbs.com.sg'], emailCc: ['admin@dbs.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4518'], emails: ['yard@sembmarine.com.sg'], emailCc: ['admin@sembmarine.com.sg'],
  ...
  },
  {
    ...
    phoneNumbers: ['(+65) 9123 4519'], emails: ['transfer@cwt.com.sg'], emailCc: ['admin@cwt.com.sg'],
