/* ─────────────────────────────────────────────────────────────────────────
   Live Tracking (Legacy) — a frozen backup snapshot of the Live Tracking page.
   Do NOT add features or refactor here; it exists only so the previous
   working version stays reachable from the "Live Tracking Legacy" menu while
   the active page (LiveTrackingPage.tsx) keeps evolving. Touch this file only
   when explicitly asked to update the legacy copy.
   ───────────────────────────────────────────────────────────────────────── */
...
export default function LiveTrackingLegacyPage() {
